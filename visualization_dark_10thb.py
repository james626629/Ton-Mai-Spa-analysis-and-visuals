...
# Define the financial data for the 10-year loan repayment period
...
cash_flows = [initial_investment] + [annual_net_cash_flow] * 10
...
# Save to CSV
csv_filename = 'ton_mai_spa_phuket_financial_projection_10thb.csv' # edit name for new file
